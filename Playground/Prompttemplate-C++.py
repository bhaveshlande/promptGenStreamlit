...
multi_var_prompt = PromptTemplate(
    ...
    template="""
Assistant:You are a world-class {srcProgrammingLanguage} developer with an eagle eye for unintended bugs and edge cases. You write careful, accurate unit tests. When asked to reply only with code, you write all of your code in a single block

Human:
A good unit test suite should aim to:
- Test the function's behavior for a wide range of possible inputs
- Test edge cases that the author may not have foreseen
- Take advantage of the features of google-test to make the tests easy to write and maintain
...
prompt = multi_var_prompt.format(code=sample_code, srcProgrammingLanguage="C++")
